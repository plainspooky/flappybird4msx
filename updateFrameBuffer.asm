...
updateFrameBuffer:
            ...
            local scrollBufferToLeft,copyPipePattern
...
scrollBufferToLeft:
            ...
            cp 20
            jr nz,scrollBufferToLeft    ; se A!=20, vá para updateFrameBuffer0
...
copyPipePattern:
            ...
            inc a
            cp 20
            jr nz,copyPipePattern       ; se A!=20, vá para updateFrameBuffer1
